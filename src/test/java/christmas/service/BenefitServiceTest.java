...
class BenefitServiceTest {
    ...
    void 증정_상품_없음() {
        //given
        Orders orders = new Orders(List.of(new OrderProduct(SEA_FOOD_PASTA, 1)), new EventCalendar(1));
    ...
    void 산타_배지() {
        //given
        Orders orders = new Orders(List.of(new OrderProduct(Product.CHOCOLATE_CAKE, 10)), new EventCalendar(3));
    ...
    void 트리_배지() {
        //given
        Orders orders = new Orders(List.of(new OrderProduct(Product.CHOCOLATE_CAKE, 5)), new EventCalendar(3));
        BenefitService service = new BenefitService(new DiscountCalculator(orders), 20000L);
        //when
        BenefitDto benefitDto = service.createBenefitDto();
        //then
    ...
    void 스타_배지() {
        //given
        Orders orders = new Orders(List.of(new OrderProduct(Product.CHOCOLATE_CAKE, 3)), new EventCalendar(3));
        BenefitService service = new BenefitService(new DiscountCalculator(orders), 20000L);
        //when
        BenefitDto benefitDto = service.createBenefitDto();
        //then
    ...
    void 배지_없음() {
        //given
        Orders orders = new Orders(List.of(new OrderProduct(Product.CHOCOLATE_CAKE, 1)), new EventCalendar(3));
        BenefitService service = new BenefitService(new DiscountCalculator(orders), 20000L);
        //when
        BenefitDto benefitDto = service.createBenefitDto();
        //then
    ...
    void 할인_목록_증정_상품_포함() {
        Orders orders = new Orders(List.of(new OrderProduct(Product.SEA_FOOD_PASTA, 10)), new EventCalendar(1));
